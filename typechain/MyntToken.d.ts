...
interface MyntTokenInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setMarketMaker(address)": FunctionFragment;
    "setPresale(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "setPresale", values: [string]): string;
  ...
  events: {
    ...
    "MarketMakerChanged(address)": EventFragment;
    "OwnershipTransferred(address,address)": EventFragment;
    "PresaleChanged(address)": EventFragment;
    "Transfer(address,address,uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "Approval"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "MarketMakerChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "PresaleChanged"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Transfer"): EventFragment;
}

export class MyntToken extends BaseContract {
  ...
  callStatic: {
    ...
    setMarketMaker(_address: string, overrides?: CallOverrides): Promise<void>;

    setPresale(_address: string, overrides?: CallOverrides): Promise<void>;
